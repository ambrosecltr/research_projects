> **Bundled snapshot note:** This is a reference copy of the Track 1 research map supplied with the GENOME pack. Paths mentioned below refer to files in the original Track 1 project and may need resolving after this pack is placed in the repository.
...
`configs/data/huggingface_sources.json`, with the
Standard Ebooks works selected in
`configs/data/standard_ebooks_selection.json`:
